...
const std::unordered_map<std::string, PropertyParams> PropertyParamsRegistry::registry_ = {
    ...
    {"pharma_hydrophobe", PropertyParams("pharma_hydrophobe", 0.0, 1.0)},
    {"pharma_lumped_hydrophobe", PropertyParams("pharma_lumped_hydrophobe", 0.0, 1.0)},
    {"pharma_zn_binder", PropertyParams("pharma_zn_binder", 0.0, 1.0)},
};
