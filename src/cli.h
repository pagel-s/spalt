...
public:
     ...
     * @param start_index Index to start parsing from (will be updated to point after parsed arguments)
    ...
    struct SurfaceParams {
        ...
        std::string program = "fibonacci"; ///< Surface generation program: "msms" or "fibonacci" (default: "fibonacci")
...
private:
     ...
     */
    static void alignFromFile(const std::string& reference_file, 
     ...
     * @param surface_params Surface generation parameters
     */
    static void alignFromSMILES(const std::string& reference_file,
     ...
     * @param surface_params Surface generation parameters
     */
    static void alignFromFolder(const std::string& reference_file,
